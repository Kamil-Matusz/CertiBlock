...
export const EthereumResearchMetricsList = () => {
        ...
        const fetchMetrics = async () => {
            try {
                ...
                const response = await fetch(
                    apiEndpoints.ethereumMetrics('researchMetricsForEthereum'),
                    {
                        headers: {
                ...
                if (!response.ok) {
                    throw new Error('Failed to fetch Ethereum research metrics');
                }
    ...
    if (metrics.length === 0) {
        return (
            <Box p={3}>
                <Alert severity="info">No research metrics available for Ethereum</Alert>
            </Box>
        );
    }
                ...
                <Table>
                    <TableHead>
                        <TableRow sx={{ backgroundColor: '#f9fafb' }}>
                            ...
                            <TableCell align="right" sx={{ fontWeight: 600, color: '#374151' }}>Cost (ETH)</TableCell>
                    ...
                    <TableBody>
                        {metrics.map((metric, index) => (
                            ...
                            >
                                ...
                                <TableCell align="right" sx={{ color: '#a855f7', fontWeight: 500 }}>
